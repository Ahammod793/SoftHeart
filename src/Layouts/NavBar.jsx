    ...
    <header className="flex flex-row items-center justify-between px-10 bg-[r#99daf8] bg-[#3b3030] py-2">
      ...
      <nav className="navbar-center">
        <ul className="flex flex-row justify-around gap-10 text-white  text-xl">
          ...
          <li>
            <Link to='/campaigns' className="hover:border-b-white hover:border-b-2 pb-1 active:border-none">
              All Campaign
            </Link>
          </li>
          <li>
            <Link to='/addCampaign' className="hover:border-b-white hover:border-b-2 pb-1 active:border-none">
              New Campaign
            </Link>
          </li>
          <li>
